...
async def test_parse_version_filename():
    ...
    assert vc._parse_version_filename("20240228_102300_123_test.py") == ("20240228_102300_123", "test.py")
    assert vc._parse_version_filename("20240101_000000_000_app.yaml") == ("20240101_000000_000", "app.yaml")
