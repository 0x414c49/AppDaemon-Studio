...
class VersionControl:
    ...
    async def create_version(self, app: str, filename: str, content: str) -> str:
        ...
        async with self._lock:
            ...
            await loop.run_in_executor(
                None,
                lambda: version_path.write_text(content, encoding='utf-8')
            )
    ...
    async def get_version(self, app: str, version: str) -> str:
        ...
        return await loop.run_in_executor(
            None,
            lambda: version_path.read_text(encoding='utf-8')
        )
        ...
        async with self._lock:
            ...
            def delete_old():
                for version_info in versions_to_delete:
                    version_path = self._get_versions_path(app) / f"{version_info.version}_{version_info.filename}"
